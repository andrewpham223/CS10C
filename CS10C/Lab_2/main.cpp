...
int main() {
    ...
    cout << "Pushing 3 to the back of the list..." << endl;
    myList->push_back(3);
    cout << "empty() returns " << myList->empty() << endl;
    ...
    cout << "Pushing 4 to the front of the list..." << endl;
    myList->push_back(4);
    cout << "empty() returns " << myList->empty() << endl;
    cout << "Printing myList in order (should print out 0 1 2 3 4): " << *myList << endl;
    cout << "Printing myList backwards (should print out 4 3 2 1 0): ";
    myList->printReverse();
    cout << endl << endl;
